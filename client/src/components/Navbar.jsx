      ...
      <nav className="mx-auto max-w-7xl rounded-2xl border border-white/70 bg-white/85 px-4 py-3 shadow-lg shadow-slate-900/5 backdrop-blur-xl md:px-6">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden items-center gap-2 lg:flex">
            ...
            <button className="rounded-xl bg-emerald-700 px-5 py-2.5 text-sm font-bold text-white shadow-md shadow-emerald-700/20 transition-all duration-200 hover:-translate-y-0.5 hover:bg-emerald-800 hover:shadow-lg">
              Join DOGGO
            </button>
          </div>
            ...
            >
              <div className="mt-3 border-t border-slate-100 pt-3">
                ...
                <div className="mt-2 flex gap-2 border-t border-slate-100 pt-3">
                  <button className="flex-1 rounded-xl px-4 py-3 text-sm font-bold text-slate-700 transition hover:bg-slate-100">
                    Login
                  </button>

                  <button className="flex-1 rounded-xl bg-emerald-700 px-4 py-3 text-sm font-bold text-white transition hover:bg-emerald-800">
                    Join DOGGO
                  </button>
                </div>
