            ...
            <div className="relative grid items-center gap-12 lg:grid-cols-[1fr_auto]">
              ...
              <div className="max-w-2xl">
                ...
                <p className="mt-5 max-w-xl text-base leading-7 text-white/60 md:text-lg">
                  Report the animal, share its
                  location and help nearby
                  rescuers understand what is
                  happening. Your few minutes
                  could change an animal's entire
                  life.
                </p>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <p className="mt-2 max-w-xs text-sm leading-6 text-white/50">
                    Help the right people find
                    the right animal at the right
                    time.
                  </p>
                  ...
                  <button
                    ...
                    className="group mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-500 px-5 py-3.5 text-sm font-bold text-white transition hover:bg-emerald-400"
                  >
                    Report an Animal
